<?php
/* Smarty version 3.1.29, created on 2016-05-20 21:48:56
  from "D:\Apache2.2\htdocs\oik\www.oik.com-master\template\login.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_573f15c8748d43_87797591',
  'file_dependency' => 
  array (
    'f49b7f1df4f3e0fa69c18aac7de1b67f3ae7899e' => 
    array (
      0 => 'D:\\Apache2.2\\htdocs\\oik\\www.oik.com-master\\template\\login.html',
      1 => 1463752127,
      2 => 'file',
    ),
  ),
...
function content_573f15c8748d43_87797591 ($_smarty_tpl) {
?>
<html class="no-js">
<head>
						...
						<div class="big-box">
							<div class="box">
								...
								<form id="form_register" name="form_register" method="post" action="register.php">
									...
									<div class="form-group">
										<input id="password_normal" type="password" name="user_password" class="form-control" easyform="length:6-16;" message="密码必须为6—16位" easytip="disappear:lost-focus;theme:red;" required>
										<label class="form-label">密码</label>
									</div>
									<div class="form-group">
										<input id="password_confirm" type="password" name="user_password" class="form-control"  easyform="length:6-16;equal:#password_normal;" message="两次密码输入要一致" easytip="disappear:lost-focus;theme:red;"required>
